...
#     echo '{ "name": "almoco-tecnico", "version": "0.0.1", "dependencies": {} }' >> package.json
#
...
#
#     git checkout deploy
#     git add ./dist/build/almoco-tecnico/almoco-tecnico
#     git commit -m deploy
#
# * push to Heroku
#
...
web: ./dist/build/almoco-tecnico/almoco-tecnico production -p $PORT
